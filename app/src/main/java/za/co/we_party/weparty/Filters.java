...
public class Filters {
    ...
    public static Filters getDefault() {
        ...
        filters.setSortBy(Club.FIELD_AVG_RATING);
    ...
    public String getSearchDescription(Context context) {
        ...
        if (price > 0) {
            desc.append(" for ");
            desc.append("<b>");
            desc.append(ClubUtil.getPriceString(price));
            desc.append("</b>");
        }
    ...
    public String getOrderDescription(Context context) {
        if (Club.FIELD_PRICE.equals(sortBy)) {
            return context.getString(R.string.sorted_by_price);
        } else if (Club.FIELD_POPULARITY.equals(sortBy)) {
