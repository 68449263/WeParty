package za.co.we_party.weparty.Util;
...
public class ClubUtil {
     ...
     */
    public static Club getRandom(Context context) {
        Club restaurant = new Club();
     ...
     */
    public static String getPriceString(Club restaurant) {
